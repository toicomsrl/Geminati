...
<section class="first-section">
    <div class="contenitore">
        <div class="box-terzo box-img-prodotto">
            <img src="<?= $URLASSOLUTO ?>img/Europellet.jpg" alt="">
        </div>
        <div class="box-dueterzi box-desc-prodotto">
            <h1 class="text-black">Europellet</h1>
            <p>Pellet di legno vergine, ricavato da conifera e latifoglia privi di corteccia.<br>Prodotto naturale di alta qualità.<br>EUROPELLET certificato in Classe ENplus A1 (la qualità più elevata), soddisfa ampiamente la norma 17225‐2 secondo lo standard europeo En Plus, il massimo della certificazione in termini di qualità e controllo continuo sul prodotto.</p>
            ...
            <div class="prodotto-download">
                <a href="<?= $URLASSOLUTO ?>doc/Scheda_Europellet_2024.pdf" class="btn-white btn-doc">Scarica scheda prodotto</a>
