...
<section class="first-section">
    <div class="contenitore">
        <div class="box-terzo box-img-prodotto">
            <img src="<?= $URLASSOLUTO ?>img/firex.jpg" alt="">
        </div>
        <div class="box-dueterzi box-desc-prodotto">
            <h1 class="text-black">Firex</h1>
            <p>Pellet di legno vergine, ricavato da conifera e latifoglia privi di corteccia.<br>Prodotto naturale di alta qualità.<br>FIREX certificato in classe A1 (la qualità più elevata), soddisfa ampiamente la norma 17225‐2 secondo lo standard europeo En Plus, il massimo della certificazione in termini di qualità e controllo continuo sul prodotto.</p>
