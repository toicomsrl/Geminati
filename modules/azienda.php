<article>
    ...
    <div class="slide slide-azienda">
        <div class="contenitore">
            <h1 class="text-bolder text-white">Geminati commercio <br>di biomasse legnose<br> di alta qualità</h1>
        </div>
    </div>
        ...
        <div class="contenitore">
            <div class="box-mezzo">
                <h2 class="text-black text-bolder">
                    Geminati <br>una scelta<br> responsabile
                </h2>
            </div>
