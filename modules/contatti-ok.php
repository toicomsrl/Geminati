<style>
    .messaggio-ok {color:#666666; font-size:50px; font-size:2em; margin:0 0 10px 0; padding:0px;}
    .contenitore-dettaglio{width:90%; max-width:1300px; margin:50px auto 150px; text-align:center;}
    h2{font-weight:normal; margin:0px; padding:0px;}
    .foto-ok{margin:30px auto; max-width:100%; display:block;}
